...
async function testAutodermAPI() {
  ...
  if (!API_KEYS.AUTODERM_API_KEY) {
    console.error('❌ Error: AUTODERM_API_KEY is not set in environment variables');
    console.log('Please make sure you have a .env.local file with the correct API key');
    return;
  }
